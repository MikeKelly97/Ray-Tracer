...
public class Example01 extends Frame {
     ...
     **/
     ...
     //Mike Kelly: constuctor now takes a world object.
    public Example01(World aWorld) {
     ...
     **/
     ...
     //Mike Kelly: I modified paint to call RayTracer and use a world object.
    ...
    for (int v = 0 ; v < HEIGHT ; v++) {
      ...
      g.setColor(RayTracer.getColor(u, v, theWorld));
